 ...
 */
public class NewDownloadActivity extends BaseActivity implements View.OnClickListener {
    //文件名
    ...
    private COSDownloadTask cosxmlTask;
    ...
    private void download() {
        if (cosxmlTask == null) {
            GetObjectRequest getObjectRequest = new GetObjectRequest(
                    bucketName,
                    download_key,
                    downloadParentDir.toString(),
                    "cos_download_" + filename);
            cosxmlTask = transferService.download(getObjectRequest);
