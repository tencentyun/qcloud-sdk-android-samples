...
//                .setAppidAndRegion(cosConfig.appid, cosConfig.region)
//                .setDebuggable(true)
//                .builder();
//
//        URL url = null;
//        try {
//            url = new URL(cosConfig.signUrl);
...
//                return new SessionQCloudCredentials("AKIDMDNUw12siXZNx723koLDz5fImhP25xXQ", "J5mzT1DqjzusMReoy8NBKwzbOyK18Fak",
//                        "d7ba8f573a0f2ad3b1264f7440b4ba37ad9a011730001", 1539922593);
//            }
//        };
//
//        /**
...
//         * Bucket，请初始化多个 {@link CosXmlService} 对象。
//         */
//        cosXmlService = new CosXmlService(context, serviceConfig, qCloudCredentialProvider);
//
//
//        TransferConfig transferConfig = new TransferConfig.Builder()
//                .build();
