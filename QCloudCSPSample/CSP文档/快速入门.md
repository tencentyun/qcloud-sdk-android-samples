...
dependencies {
	...
    // 增加这行
    compile 'com.tencent.qcloud:cosxml:5.6.0'
}
```
...
{"sign":"q-sign-algorithm=sha1&q-ak=AKxxxxxxxx&q-sign-time=1537494643;1537495243&q-key-time=1537494643;1537495243&q-header-list=&q-url-param-list=&q-signature=5a80f9fd31a4db772969a164bdad15a96efee73c"}
```
